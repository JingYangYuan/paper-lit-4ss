...
- 适用宿主：OMP。ZCode 宿主读 [cnki-kns8s-closed-loop.md](cnki-kns8s-closed-loop.md) §2.1 的 browser-use 分支。
- 能力映射：`browser_control`（见 `references/runtime-adapter.md`、`references/agent-software-adapters.md`）。
